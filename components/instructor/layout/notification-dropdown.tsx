...
const typeColors: Record<string, string> = {
  ...
  course_completed: "bg-primary/10 text-primary",
  course_assigned: "bg-info/10 text-info",
  course_removed: "bg-warning/10 text-warning",
  account_deactivated: "bg-destructive/10 text-destructive",
...
export function InstructorNotificationDropdown({ open, onClose }: InstructorNotificationDropdownProps) {
  ...
  React.useEffect(() => {
    const handleClickOutside = (e: MouseEvent) => {
      if (
        ...
        !(e.target as Element)?.closest("#instructor-notification-bell")
      ) {
        onClose()
      }
    }
